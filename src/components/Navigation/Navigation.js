    ...
    <div className="navigation">
      ...
      {props.loggedIn
        ? (<nav className="navigation__menu">
            <Link to="/" className="navigation__link navigation__text opacity tab tap-highlight">Главная</Link>
            <Link to="/saved-news" className="navigation__link navigation__text opacity tab tap-highlight">Сохранённые статьи</Link>
